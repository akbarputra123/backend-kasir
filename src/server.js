...
const { verifyMailConnection } = require("./mail/mail.config");
...
const startServer = async () => {
  ...
  server.listen(PORT, HOST, () => {
    ...
    console.log(
      `Network / WiFi API : ${networkApiUrl}`
    );

    console.log(
      `Public VPS API     : ${publicApiUrl}`
    );
    ...
    console.log(
      `Swagger Local      : ${localSwaggerUrl}`
    );

    console.log(
      `Swagger Network    : ${networkSwaggerUrl}`
    );

    console.log(
      `Swagger Public     : ${publicSwaggerUrl}`
    );
    ...
    console.log(
      "💻 Untuk laptop/server lokal:"
    );

    console.log(
      `Gunakan base URL : ${localApiUrl}`
    );

    console.log("");

    console.log(
      "📱 Untuk Flutter / HP fisik satu WiFi:"
    );

    console.log(
      `Gunakan base URL : ${networkApiUrl}`
    );

    console.log("");

    console.log(
      "🌐 Untuk akses dari internet / VPS:"
    );

    console.log(
      `Gunakan base URL : ${publicApiUrl}`
    );
